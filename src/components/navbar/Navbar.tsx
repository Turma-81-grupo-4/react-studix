  ...
  return (
    ...
    //     if (token !== '') {
            ...
            <div className='flex gap-4 items-center'> 
                    <Link to='/login' className='text-white hover:text-[#60B657] font-semibold cursor-pointer'>
                        Login
                    </Link>
                    <Link to='/cadastro' className='text-white hover:text-[#60B657] font-semibold cursor-pointer'>
                        Cadastre-se
                    </Link>
            </div> 
        </nav>
