...
const integrantes = [
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/carlos-henrique-da-silva-barbosa-no-linked-in/",
...
function Sobre() {
  return (
    <>
      {/* Seção principal */}
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-[#1A5566] to-[#068DBD] px-4 py-12">
        <h1 className="text-5xl text-white m-4 text-center font-extrabold">
          Studix - Conhecimento é a chave para o futuro
        </h1>
        <p className="text-white text-lg max-w-3xl text-center mb-12 leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch mb-16 max-w-6xl">
          <div className="flex-1 bg-gradient-to-br from-white/40 to-white/10 border border-white/30 rounded-2xl p-6 shadow-lg backdrop-blur-sm transition-transform hover:scale-105 hover:shadow-2xl"          >
            <h3 className="text-3xl text-gray-900 mb-4 text-center font-extrabold tracking-tight">
              Missão
            </h3>
            <p className="text-gray-800/90 text-center text-lg leading-relaxed flex-grow">
            Capacitar educadores a democratizar o acesso ao conhecimento por meio de
              uma plataforma digital inovadora, que facilite a criação, gestão e
              expansão de cursos online com autonomia, segurança e excelência.
            </p>
          </div>
          <div className="flex-1 bg-gradient-to-br from-white/40 to-white/10 border border-white/30 rounded-2xl p-6 shadow-lg backdrop-blur-sm transition-transform hover:scale-105 hover:shadow-2xl">
            <h3 className="text-3xl text-gray-900 mb-4 text-center font-extrabold tracking-tight">Visão</h3>
            <p className="text-gray-800/90 text-center text-lg leading-relaxed flex-grow">
            Tornar-se a plataforma líder e referência global em educação digital,
              reconhecida por transformar vidas, impulsionar educadores e fomentar
              uma comunidade engajada e colaborativa.
            </p>
          </div>
          <div className="flex-1 bg-gradient-to-br from-white/40 to-white/10 border border-white/30 rounded-2xl p-6 shadow-lg backdrop-blur-sm transition-transform hover:scale-105 hover:shadow-2xl"          >
            <h3 className="text-3xl text-gray-900 mb-4 text-center font-extrabold tracking-tight">Valores</h3>
            <p className="text-gray-800 text-lg leading-relaxed flex-grow">
              <strong>Paixão pela Educação:</strong> Acreditamos no poder transformador do ensino.<br />
              <strong>Empoderamento do Educador:</strong> Colocamos o professor no centro da inovação.<br />
              <strong>Inovação Contínua:</strong> Evoluímos constantemente para oferecer o melhor.<br />
              <strong>Inclusão e Acessibilidade:</strong> Educação para todos, sem barreiras.<br />
              <strong>Compromisso com a Qualidade:</strong> Entregamos uma experiência profissional e confiável.
            </p>
          </div>
        </div>
        ...
        <h2 className="text-4xl text-white mb-8 font-semibold">Nosso Time</h2>
